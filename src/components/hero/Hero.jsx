        ...
        <div className="w-full bg-black mb-20">
            <div className="container mx-auto flex-col xl:flex-row flex justify-between items-center xl:items-start h-full">
                <div className=" ml-0  mt-5 mb-32 xl:ml-16 xl:mt-48 h-64 flex flex-col items-center md:items-start">
                    ...
                    <button className="jello-horizontal bg-black text-cyan-500 border-2 border-cyan-500 mt-20 py-5 px-20 text-4xl flex justify-center items-center font-bold hover:bg-cyan-500 hover:text-white transition-colors duration-100 rounded-full">
                        <a href="#">Read more</a>
                    </button>
                </div>
