        ...
        <div className="h-screen w-full bg-black">
            <div className="container mx-auto flex-col xl:flex-row flex justify-between items-center xl:items-start h-full">
                <div className=" ml-0  mt-5 mb-32 xl:ml-16 xl:mt-48 h-64 flex flex-col items-center md:items-start">
                    ...
                    <button className="jello-horizontal bg-white text-black mt-20 py-5 px-20 text-4xl flex justify-center items-center font-bold hover:bg-cyan-500 hover:text-white transition-colors duration-100 rounded-full">
                        <a href="#">Read more</a>
                    </button>
                </div>
